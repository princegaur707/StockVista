...
const MarketDataTable = ({ updateToken, displayTopGainers, displayTopLosers, setSymbolToken, liveMarketData }) => {
  ...
  const columns = [
    ...
    { field: 'netChange', headerName: 'Change', headerClassName: 'header-name', flex: 1, type: 'number' },
    { field: 'tradeVolume', headerName: 'Volume', headerClassName: 'header-name', flex: 1, type: 'number' },
    {
      field: 'price_rating',
